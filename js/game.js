...
//
//   if(!playing) {
//     let start_stage = new createjs.Stage(canvas);
//     start_stage.canvas.width = window.innerWidth;
//     start_stage.canvas.height = window.innerHeight;
//
//     let splashScreen = new createjs.Shape();
//     splashScreen.graphics.f('gray').rc(
//       start_stage.canvas.width / 2 - 250, start_stage.canvas.height / 2 - 250,
//       500, 500, 10, 10, 10, 10
//     );
//     splashScreen.addEventListener('click', init);
//
//     let splashScreenText = new createjs.Text(
//       'Welcome to Mount Bash',
//       '32px Space Mono',
//       'white'
//     );
//     splashScreenText.x = start_stage.canvas.width / 2 - 170;
//     splashScreenText.y = start_stage.canvas.height / 2 - 50;
//
//     start_stage.addChild(splashScreen);
//     start_stage.addChild(splashScreenText);
//     start_stage.update();
//     playing = true;
//   } else {
...
//       if(bool) {
//         correctMessage = new createjs.Shape();
...
//           'White'
//         );
//         correctMessageText.x = wid / 2 - 300;
//         correctMessageText.y = hei / 2 - 160;
//       }
//
